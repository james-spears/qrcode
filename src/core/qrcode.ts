...
function createData(
    ...
    segments.forEach(function (data) {
        ...
        if (data.write) data.write(buffer);
    });
...
function createCodewords(
    ...
    const rs = new ReedSolomonEncoder.ReedSolomonEncoder(ecCount);
 ...
 */
export const create = (data: string, options: QRCodeOptions): QRCode => {
