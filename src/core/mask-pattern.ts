 ...
 */
export const getPenaltyN1 = (data: BitMatrix): number => {
 ...
 * Points: N2 * (m - 1) * (n - 1)
 */
export const getPenaltyN2 = (data: BitMatrix): number => {
    const size = data.size;
    let points = 0;
 ...
 */
export const getPenaltyN3 = (data: BitMatrix): number => {
    const size = data.size;
    let points = 0;
    let bitsCol = 0;
    let bitsRow = 0;
 ...
 */
export const getPenaltyN4 = (data: BitMatrix): number => {
    let darkCount = 0;
 ...
 */
export const applyMask = (pattern: number, data: BitMatrix): void => {
    const size = data.size;
...
export const getBestMask = (
    data: BitMatrix,
    setupFormatFunc: (arg: number) => unknown
): number => {
    const numPatterns = Object.keys(Patterns).length / 2;
    let bestPattern = 0;
